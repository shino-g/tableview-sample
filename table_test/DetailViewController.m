...
- (void)viewDidLoad
{
    ...
    UILabel *descriptionLabel  = [[UILabel alloc] initWithFrame:CGRectMake(10, 15, 300, 200)];
    descriptionLabel.text      = modelDetail.detailDescription;

    UIImageView *imageView     = [[UIImageView alloc] initWithImage:modelDetail.detailImage];
